"""Components 2 (How much) v1
Ask the user how much they want to play with and check that the input is a valid
integer between 1 and 10. If it is, this amount becomes the balance in their account
"""
